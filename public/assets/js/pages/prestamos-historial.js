        ...
        columns: [
            {
                ...
                render: function (data, type) {
                    if (type === 'display') { 
                        return `<a class="btn btn-primary" href="${ base_url + 'prestamos/' + data.id + '/detail' }"><i class="fas fa-eye"></i></a>
            ...
            //nombre y apellido
            {
                ...
                render: function (data, type) {
                    if (type === 'display') { 
                        return `<li class="list-group-item">${data.identidad + ': ' + data.num_identidad}</li>
                        <li class="list-group-item">${data.nombre + ' ' + data.apellido}</li>
                        <li class="list-group-item">Fecha: ${data.fecha}</li>
                        <li class="list-group-item">Tasa interes: ${data.tasa_interes}</li>
                        <li class="list-group-item">Cuotas: ${data.cuotas}</li>`;
                    }
                    return data;
                },
            },
